            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <div class="row total-header-section">
                        ...
                        <?php $tot+=$details['price']*$details['quantity'];?>
                            @endforeach
                        @endif
                        <div class="col-lg-6 col-sm-6 col-6 total-section text-right">
                            <p>Total: <span class="text-info">{{$tot}}4</span></p>
                        </div>
                    </div>
                    @if(session()->get('cart2'))
                    ...
                    <div class="row cart-detail">
                        <div class="col-lg-4 col-sm-4 col-4 cart-detail-img">
                            <img src="{{asset('storage/img/product' . $details['photo'])}}">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-12 text-center checkout">
                            <a href="{{ route('submitCheckout')}}" class="btn btn-primary btn-block">CHECKOUT</a>
                        </div>
                    </div>
                </div>
            </div>
