...
<body class="page-header-fixed">
            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu">
                    ...
                    <li class="active ">
                        ...
                        <ul class="sub-menu">
                            <li class="active">
                                <a href="{{route('reportShowMedNameFormCatid')}}">
                                    Medicine Name, Form, Category ID</a>
                            </li>
                            <li>
                                <a href="{{route('reportShowMedNameFormPrice')}}">
                                    Medicine Name, Form, Price</a>
                            </li>
                            <li>
                                <a href="{{route('reportShowAggregation')}}">
                                    Aggregation</a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="page-content">
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            &nbsp;
                            <a href="#" onclick="showHighestPrice()">
    ...
    <!-- END CORE PLUGINS -->
    <script src="{{ asset('conquer2/scripts/app.js') }}"></script>
    <script>
